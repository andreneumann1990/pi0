...
main_4 <- function() {
  seed <- seed(535734) #535734

  # independence setting
  default <- list(rho = 0, n = 100, m = 100, pi0 = 0.5, mu = 1, lambda = 0.5)
  ...
  results <- list(pi0_hat = results, pi0 = default$pi0, pi0_hat_SS = pi0_SS,
                  pi0_hat_BSS = pi0_BSS)
  save(results, file = "2018-10-30-pi0-histogram-2.RData")
  results
}
...
plot_histograms <- function(results, pi0) {
  ...
  ggsave("2018-10-30-pi0-histogram-2-SS.png", width = 6.4, height = 6.4)
  print(gg)
  ...
  ggsave("2018-10-30-pi0-histogram-2-BSS.png", width = 6.4, height = 6.4)
  print(gg)
}
