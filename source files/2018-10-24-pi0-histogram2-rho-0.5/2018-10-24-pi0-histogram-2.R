...
main_4 <- function() {
  ...
  results <- list(pi0_hat = results, pi0 = default$pi0, pi0_hat_SS = pi0_SS,
                  pi0_hat_BSS = pi0_BSS)
  save(results, file = "2018-10-24-pi0-histogram-2.RData")
  results
}
...
plot_histograms <- function(results, pi0) {
  ...
  ggsave("2018-10-24-pi0-histogram-2-SS.png", width = 6.4, height = 6.4)
  print(gg)
  ...
  ggsave("2018-10-24-pi0-histogram-2-BSS.png", width = 6.4, height = 6.4)
  print(gg)
}
